...
class ContractAdapter:
    ...
    PRICE_WEI = {
        "bronze": 6000000000000000000,    # 6 SOMI (Bronze Key on contract)
        "silver": 10000000000000000000,   # 10 SOMI (Silver Key on contract)
        "gold":   20000000000000000000    # 20 SOMI (Gold Key on contract)
    }
